...
def gpt_coach(medical_context, conversation,regen=1, max_regen=5, retry=1, max_retry=5):
    prompt = """Based on the provided <medical context>:\n""" + \
        ...
        conversation + '\n' + \
        """In this simulated dialogue, you are a language coach assisting a doctor in providing accurate medical advice. You only care about doctor's sentences.
        Your task is to identify any discrepancies between the doctor's dialogue and the correct responses provided for comparison. 
        ...
        Please note that you should interact directly with the doctor. Your task is to revise the dialogue and provide the coaching directly to the doctor. For a more natural dialogue, please remove references to the correct responses.

        The conversation flow in the generated dialogue should be as follows:
        ...
        Use the given information (including difference between the doctor's dialogue and the correct responses as well as the provided medical context) to add content for the coach and rewrite the dialogue if necessary. The dialogue includes three participants: the doctor, the patient, and the coach.
